...
public class EscaneoTrabajadorSalidaActivity  extends mx.linkom.caseta_dm_offline.Menu{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    Conf.setST("Denegado");
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_dm_offline.AccesosTrabajadorSalidaActivity.class);
                    startActivity(i);
                    finish();
                }else {
